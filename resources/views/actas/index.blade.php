        ...
        <table id="actasTable" class="table table-bordered table-hover w-100">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('actas.show', $acta->id_Actas) }}" class="btn btn-info btn-sm"><i class="bi bi-eye"></i> Ver</a>
                        <a href="{{ route('actas.edit', $acta->id_Actas) }}" class="btn btn-warning btn-sm"><i class="bi bi-pencil"></i> Editar</a>
